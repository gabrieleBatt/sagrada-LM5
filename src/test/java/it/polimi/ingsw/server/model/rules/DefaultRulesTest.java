...
class DefaultRulesTest {
    ...
    @Test
    void dealGlassWindow() throws BagEmptyException, GlassWindowNotFoundException, EndGameException, DeckTooSmallException, PlayerNotFoundException, CellNotFoundException, DieNotAllowedException {
    ...
    @Test
    void dealPrivateObjective() throws BagEmptyException, GlassWindowNotFoundException, EndGameException, DeckTooSmallException, PlayerNotFoundException, CellNotFoundException, DieNotAllowedException {
    ...
    @Test
    void dealPublicObjective() throws BagEmptyException, GlassWindowNotFoundException, EndGameException, DeckTooSmallException, PlayerNotFoundException, CellNotFoundException, DieNotAllowedException {
    ...
    @Test
    void getRoundAction() throws BagEmptyException, GlassWindowNotFoundException, EndGameException, DeckTooSmallException, PlayerNotFoundException, CellNotFoundException, DieNotAllowedException {
