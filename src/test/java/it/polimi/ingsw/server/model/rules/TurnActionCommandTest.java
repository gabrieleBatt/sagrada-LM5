...
class TurnActionCommandTest {
    ...
    @Test
    void execute() throws PlayerNotFoundException, BagEmptyException, GlassWindowNotFoundException, EndGameException, DeckTooSmallException, CellNotFoundException, DieNotAllowedException {
